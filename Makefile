#############################################################################
# Makefile for building: imgViewer
# Generated by qmake (2.01a) (Qt 4.5.3) on: ?? 5? 18 23:22:10 2017
# Project:  imgViewer.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.5.3/bin/qmake -unix -o Makefile imgViewer.pro
#############################################################################
...
Makefile: imgViewer.pro  /usr/local/Trolltech/Qt-4.5.3/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.5.3/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.5.3/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.5.3/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.5.3/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.5.3/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile imgViewer.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/imgViewer1.0.0 || $(MKDIR) .tmp/imgViewer1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/imgViewer1.0.0/ && $(COPY_FILE) --parents MyWidget.h .tmp/imgViewer1.0.0/ && $(COPY_FILE) --parents main.cpp MyWidget.cpp .tmp/imgViewer1.0.0/ && (cd `dirname .tmp/imgViewer1.0.0` && $(TAR) imgViewer1.0.0.tar imgViewer1.0.0 && $(COMPRESS) imgViewer1.0.0.tar) && $(MOVE) `dirname .tmp/imgViewer1.0.0`/imgViewer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/imgViewer1.0.0
